...
try {
	...
	public static void clickOnhomescreenstickytestad() throws Exception {
		attachScreen();
		System.out.println("clicking test ad");
		logStep("clicking test ad");
		Ad.findElementById("com.weather.Weather:id/sticky_ad_container").click();
		Thread.sleep(15000);
		
	}
	
	public static void  verifyingtapabilityoftesads() {
		if(Ad.findElementById("com.weather.Weather:id/sticky_ad_container").isDisplayed()) {
			attachScreen();
			System.out.println("unable to click the test ad");
			logStep("unable to click the test ad");
			Assert.fail("unable to click the test ad");
		}
		else {
			System.out.println("test ad was clicked successfully");
			logStep("test ad was clicked successfully");
			attachScreen();
		}
	}
...
//			}
	...
	public static void clickOnsettingIcon() throws Exception {
		AppFunctions.verifyElement(ByAccessibilityId("Setting Icon"));
			try {
	...
	//	Functions.verifyElement(ByAccessibilityId("About this App"));
		...
		new WebDriverWait(Ad, Functions.maxTimeout).until(ExpectedConditions.elementToBeClickable(Ad.findElementByAccessibilityId("Setting icon")));
		Ad.findElementByAccessibilityId("Setting icon").click();
	    Thread.sleep(5000);
		}
		catch(Exception e) {	
	...
	public static void clickOnAboutthisapp_UPSX() throws Exception {
	//	Functions.verifyElement(ByAccessibilityId("About this App"));
		try {
...
public static void gettingApkVersion() throws Exception{
	...
	try {
		...
		//apkVersion=Ad.findElementById("com.weather.Weather:id/about_version").getText();
		apkVersion=Ad.findElementByXPath("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/android.widget.RelativeLayout/android.widget.FrameLayout/android.widget.LinearLayout/android.widget.FrameLayout/androidx.recyclerview.widget.RecyclerView/android.widget.LinearLayout[5]").getText();
	}
...
public static void gettingApkVersion_UPSX() throws Exception{
